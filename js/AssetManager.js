...
export default class AssetManager{
    constructor(){
        this.store = {
            images : {
                ...
                'rhinoRight'            : 'img/rhino_run_right.png',
                'tree'                  : 'img/tree_1.png',
    ...
    /**
     * Gets a specific image asset from the store
     * @return string
     */
    getImageAsset(name){
        return this.store['images'][name];
    }
    /**
     * Gets a specific audio asset from the store
     * @return string
     */
    getAudioAsset(name){
        return this.store['audio'][name];
    }
